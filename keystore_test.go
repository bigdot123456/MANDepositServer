...
func checkAccounts(t *testing.T, live map[common.Address]accounts.Account, wallets []accounts.Wallet) {
	...
	//sort.Sort(keystore.accountsByURL(liveList))
...
func tmpKeyStore(t *testing.T, encrypted bool) (string, *keystore.KeyStore) {
	...
	// newkey 作为函数引用
	newkey:=keystore.NewPlaintextKeyStore

	if encrypted {
		newkey= func(kd string) *keystore.KeyStore { return keystore.NewKeyStore(kd, veryLightScryptN, veryLightScryptP) }
	}
	return d, newkey(d)
}
